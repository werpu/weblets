...
/**
 * A security enabler to jail
 * our resources so that no request can break out
 * of our jailed paths!
 *
 */
public class SandboxGuard {
    ...
    public static boolean isJailBreak(String origResourcePath) {
        ...
        for(int cnt = 0; cnt < len; cnt++) {
           ...
           if(interimbreak == 0) return true;
           /*
             we stepped out of our given root this is a clear break
             you can jump into a sidedir that way
            */
        }
