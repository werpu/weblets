...
<div class="content">
    ...
    <p>
        the getURL results are absolute to the context, note this only works either if you are in a jee5 environment or
        if you set the weblets filter, alternatively as final override you can set a
