...
<head>
    ...
    <script type="text/javascript"
            src='<%= jspweblet.getURL( "org.dojotoolkit","/dijit/tests/_testCommon.js") %>'></script>
...
<div style="border: 1px solid black;">
    <div dojoType="dijit.Editor" id="editor1"><p>This instance is created from a div directly with default toolbar and
        plugins</p></div>
</div>
...
<div style="border: 1px dotted black;">
    ...
    <textarea dojoType="dijit.Editor"
        ...
        <ol>
            <li>specify which plugins to load (see the plugins property): this instance loads EnterKeyHandling plugin,
                among others;
            </li>
