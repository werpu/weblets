...
<html>
    <head>
        ...
        <style type="text/css">
		@import '.<%= jspweblet.getResource( "org.dojotoolkit","/dojo/dojo.css") %>';
		@import '.<%= jspweblet.getResource( "org.dojotoolkit","/dijit/tests/css/dijitTests.css") %>';
	</style>
    <script type="text/javascript" src='.<%= jspweblet.getResource( "org.dojotoolkit","/dojo/dojo.js" )%>'
		djConfig="parseOnLoad: true, isDebug: true"></script>
	<script type="text/javascript" src='.<%= jspweblet.getResource( "org.dojotoolkit","/dijit/tests/_testCommon.js") %>'></script>


    <script type="text/javascript" src='.<%= jspweblet.getResource( "org.dojotoolkit","/dijit/Editor.js") %>'></script>
...
//		dojo.require("dijit._editor.plugins.FontChoice");  // 'fontName','fontSize','formatBlock'
    ...
    <body>
        ...
        <script type="text/javascript" src='.<%= jspweblet.getResource( "weblets.demo","/dojotest.js") %>'></script>
	...
	<div style="border: 1px dotted black;">
		...
		<textarea dojoType="dijit.Editor" height=""
			...
			styleSheets='.<%= jspweblet.getResource( "org.dojotoolkit","/dojo/resources/dojo.css") %>' id="thud">
			<p>
	...
	<div style="border: 1px dotted black;">
		...
		<textarea dojoType="dijit.Editor"
			...
			styleSheets='.<%= jspweblet.getResource( "org.dojotoolkit","dojo/resources/dojo.css") %>' id="blah">
	...
	<div style="border: 1px dotted black;">
		...
		<textarea dojoType="dijit.Editor"
			...
			styleSheets='.<%= jspweblet.getResource( "org.dojotoolkit","dojo/resources/dojo.css") %>' id="blah2">
