...
<div class="content">
    ...
    <ul>
        ...
        <li>
            <a href="./localresource.jsp">A demo utilizing the webapp weblet to serve resources from the local web
                application</a>
        </li>
        <li>
        ...
        <li>
            <a href="./faces/jsfsubbundles.jspx">Subbundles on JSF level</a>
        </li>
